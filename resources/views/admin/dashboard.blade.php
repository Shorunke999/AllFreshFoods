...
<div class="py-12">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <h2 class="font-semibold text-2xl text-gray-800 mb-6">Admin Dashboard</h2>
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
            ...
            <div class="bg-white overflow-hidden shadow-sm rounded-lg p-6">
                ...
                <div class="text-3xl font-bold text-gray-900 mt-2">{{ $stats['total_products'] ?? 0 }}</div>
            </div>

            <!-- Total Orders -->
            <div class="bg-white overflow-hidden shadow-sm rounded-lg p-6">
                <div class="text-gray-500 text-sm font-medium">Total Orders</div>
                <div class="text-3xl font-bold text-gray-900 mt-2">{{ $stats['total_orders'] ?? 0 }}</div>
            </div>
        ...
        <div class="bg-white overflow-hidden shadow-sm rounded-lg">
            <div class="p-6">
                ...
                @else
                    <p class="text-gray-500 text-center py-8">No recent products</p>
                @endif
            </div>
        </div>
    </div>
